...
public class BoardController {
	...
	public String list(@ModelAttribute("boardVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		/* EgovPropertyService.sample
		   properties는 spring폴더에 모든 xml파일을 말함 (context-properties파일에서 정의 */
	...
	public String login(@RequestParam("user_id") String user_id, @RequestParam("password") String password,
		...
		//String aa = request.getParameter("user_id");  @RequestParam을 통해 가져오는 것과 동일
		//String bb = request.getParameter("password"); @RequestParam을 통해 가져오는 것과 동일
		...
		if(user_name != null && !"".equals(user_name)) {
			...
			redirectAttributes.addFlashAttribute("msg", "사용자 정보가 올바르지 않습니다.");
		}
