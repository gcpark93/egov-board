...
<html lang="ko" dir="ltr">
  ...
  <body>
    <div class="container">
      <h1>상세화면</h1>
        <form id="fomr1" name="form1" class="form-horizontal" method="post" action="">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="titile">제목:</label>
              <div class="col-sm-10 control-label" style="text-align:left;">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10 control-label" style="text-align:left;">
                <a href="javascript:getfile('${boardVO.filename}');"><c:out value="${boardVO.filename}"/></a>
                &nbsp;
                <c:if test="${not empty sessionScope.userId && sessionScope.userId == boardVO.writer && not empty boardVO.filename}">
          ...
          <c:if test="${not empty sessionScope.userId && sessionScope.userId == boardVO.writer}">
      ...
      <div class="well well-lg">
        <form id="fomr2" name="form2" class="form-horizontal" method="post" action="">
          <div class="form-group">
